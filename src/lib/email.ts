...
export const sendOtpEmail = async (
                ...
                <tr>
                  <td style="padding:40px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-top: 20px;">
                      <tr>
                        <td align="center">
                          <p style="color:#555;font-size:15px;margin-bottom:20px;">Click the button below to go to the verification page:</p>
                          <a href="${verificationLink}" 
                             style="background-color:#F97316; color:#ffffff; padding:16px 36px; text-decoration:none; border-radius:8px; font-weight:bold; display:inline-block; font-size:16px; box-shadow: 0 4px 6px rgba(249, 115, 22, 0.2);">
                            Verify OTP
                          </a>
                        </td>
                      </tr>
  ...
  return sendEmail({
    to,
    toName,
    subject: "Your Miles Car Rental Password Reset OTP",
    htmlContent,
    textContent: `Your OTP code is: ${otp}. Use this link to verify: ${verificationLink}`,
  });
};
...
export const sendWelcomeEmail = async (
  ...
  const htmlContent = `
    ...
    <html>
      <head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
        <title>Welcome to Miles Car Rental</title>
      </head>
      <body style="margin:0;padding:0;background-color:#f4f4f4;font-family:Arial,sans-serif;">
        <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f4f4f4;padding:40px 0;">
          <tr>
            <td align="center">
              <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.05);">
                ...
                <tr>
                  <td style="padding:40px;">
                    <h2 style="color:#1a1a1a;margin:0 0 12px;">Welcome to Miles!</h2>
                    <p style="color:#555;font-size:15px;line-height:1.6;margin:0 0 24px;">
                      Hi ${toName}, we're excited to have you! To start renting, please verify your account using the code below. It expires in <strong>10 minutes</strong>.
                    </p>
  ...
  <tr>
    <td align="center">
      <p style="color:#555;font-size:15px;margin-bottom:20px;">Or click here to verify automatically:</p>
      
      <!-- This inner table acts as the actual button container -->
      <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center" style="border-radius: 8px;" bgcolor="#F97316">
            <a href="${verificationLink}" 
               target="_blank" 
               style="font-size: 16px; font-family: Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 8px; padding: 16px 36px; border: 1px solid #F97316; display: inline-block; font-weight: bold;">
              Verify My Account
            </a>
          </td>
        </tr>
